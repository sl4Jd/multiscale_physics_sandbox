    ...
    if (ImGui::Button(tr("menu.create").c_str(), ImVec2(200, 70)))
    {
        ...
        if (inputBuffer[0] == '\0') {
            ...
            if(filesystem::exists(projectPath)) {
                ...
                ofs << "  \"objects\": [\n";
                ofs << "    { \"name\": \"object1\", \"type\": \"model\", \"shape\": \"backpack\", \"posx\": 10.0, \"posy\": 0.0, \"posz\": 0.0,  \"scalex\": 0.33, \"scaley\": 0.33, \"scalez\": 0.33, \"texture\": \"\"},\n";
                ofs << "    { \"name\": \"object2\", \"type\": \"primitive\", \"shape\": \"cube\",  \"posx\": -1.0, \"posy\": 0.0, \"posz\": -1.0,  \"scalex\": 1.0, \"scaley\": 1.0, \"scalez\": 1.0, \"texture\": \"marble_tex\"},\n";
                ofs << "    { \"name\": \"object3\", \"type\": \"primitive\", \"shape\": \"cube\",  \"posx\": 2.0, \"posy\": 0.0, \"posz\": 0.0,  \"scalex\": 1.0, \"scaley\": 1.0, \"scalez\": 1.0, \"texture\": \"marble_tex\"},\n";
                ofs << "    { \"name\": \"object4\", \"type\": \"primitive\", \"shape\": \"plane\",  \"posx\": 0.0, \"posy\": 0.0, \"posz\": 0.0,  \"scalex\": 1.0, \"scaley\": 1.0, \"scalez\": 1.0, \"texture\": \"metal_tex\"}\n";
                ofs << "  ],\n";
                ofs << "  \"skybox\": \"skybox\"\n";
                ofs << "}\n";
